...
{{--                        <div class="imageBox">--}}
{{--                            <img src="{{\Illuminate\Support\Facades\URL::asset('images/Book.png')}}" alt="">--}}
{{--                        </div>--}}
{{--                        <div class="textBox">--}}
{{--                            <h5>Свалете БЕЗПЛАТНО '10 Златни Правила на Крипто Инвеситора'</h5>--}}
{{--                            <p mt-3>Научете всичко, което трябва да знаете за инвестиции в Биткойн и други криптовалути директно от хора с 7 годишен опит в сферата</p>--}}
{{--                            <div class="book-success-wrapper"></div>--}}
{{--                            <div class="book-errors-wrapper"></div>--}}
{{--                            <label for="email" class="mt-4">Вашият E-mail адрес:</label>--}}
{{--                            <span class="inputRow">--}}
{{--                                <input type="text" id="book_email" name="book_email" placeholder="Email">--}}
{{--                                <input id="book_link" type="hidden" name="footer_link" value="{{ route('subscribers.storeBookSubscribe') }}">--}}
{{--                                <button class="submitBtn" type="button" onclick="submit_subscriber('book'); return false;" style="text-transform: uppercase;">СВАЛИ СЕГА</button>--}}
{{--                            </span>--}}
{{--                            <span class="warningRow mt-3">--}}
{{--                                <img src="{{\Illuminate\Support\Facades\URL::asset('images/warningBlack.svg')}}" alt="">--}}
{{--                                <p><b>ВАЖНО:</b> Ние никога няма да ви пращаме спам или да продаваме данните ви на трети лице.</p>--}}
{{--                            </span>--}}
{{--                        </div>--}}
{{--                    </div>--}}
                </div>
