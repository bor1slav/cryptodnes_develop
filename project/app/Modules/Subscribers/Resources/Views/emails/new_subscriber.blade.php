                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" id="templateBody" width="100%">
                                            ...
                                            <tr>
                                                <td class="bodyContent" mc:edit="body_content00" valign="top">
                                                    <h1 style="color:#00000; font-size:20px;font-weight:bold;">CryptoDnes.bg ви Благодари, че се абонирахте за нашия онлайн бюлетин!</h1>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="bodyContent" mc:edit="body_content01" valign="top">
                                                    <p>Пазарът на криптовалути е изключително волативен пазар, но сега вече няма да изпуснете важна новина!</p>
                                                    <p>Вече имате възможност да получавате всякакъв вид допълнителна полезна информация от света на криптовалутите, блокчейн и финтех технологията.</p>
                                                    <p>Екипът на CryptoDnes.bg ви благодари отново за абонирането и се надява времето прекарано в сайта да ви информарима максимално за случващото се в крипто екосистемата.</p>
                                                    <p>Имате възможност да прекратите абонамента си по всяко време <a href="{{ route('subscribers.unsubscribe', ['email' => $email]) }}">ОТ ТУК</a></p>
                                                </td>
                                            </tr>
